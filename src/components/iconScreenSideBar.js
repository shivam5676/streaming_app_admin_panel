...
const IconScreenSideBar = () => {
  ...
  const menuItems = [
    {
      title: "Dashboard",
      icon: <HiOutlineHome className="h-[55px] w-[24px]" />,
      subItems: ["Dashboard"],
    },
    {
      title: "Movies",
      icon: <MdOutlineMovie className="h-[55px] w-[24px]" />,
      subItems: ["Add Movies", "All Movies"],
    },
    {
      title: "Hero",
      icon: <GrVmMaintenance className="h-[55px] w-[24px]" />,
      subItems: ["Add Slider", "All Slider"],
    },
    {
      title: "Layout",
      icon: <TfiLayoutGrid3 className="h-[55px] w-[24px]" />,
      subItems: ["Add Layout", "All Layout"],
    },
    {
      title: "Movies",
      icon: <BiSolidCameraMovie className="h-[55px] w-[24px]" />,
      subItems: ["Add Movie", "All Movie"],
    },
    ,
    {
      title: "Web shows",
      icon: <SiWebflow className="h-[55px] w-[24px]" />,
      subItems: ["Add Shows", "All Shows"],
    },
    ,
    {
      title: "Ads",
      icon: <RiAdvertisementFill className="h-[55px] w-[24px]" />,
      subItems: ["Add Ads", "All Ads"],
    },
    ,
    {
      title: "Users",
      icon: <GrUserSettings className="h-[55px] w-[24px]" />,
      subItems: ["Users"],
    },
          ...
          {hoveredItem === index && (
            ...
            >
              {item.subItems.map((subItem, subIndex) => (
                <p
                  key={subIndex}
                  className="text-[1rem] h-[56px] font-semibold flex items-center"
                >
                  {subItem}
                </p>
              ))}
