            ...
            <div className="m-4 font-normal text-[.9rem] min-w-[640px]">
              ...
              {allNotifications.length > 0 &&
                allNotifications.map((current, index) => (
                  <>
                    <div className="font-normal text-[.9rem] flex my-2  border-b border-gray-500">
                    ...
                    {moreDetails==index&&<div className="grid grid-cols-2 2xl:grid-cols-3 gap-2 text-[.8rem]">
                      <div className="flex">
                      ...
                      <div className="flex">
                        ...
                        <span className="px-2">{current.lastErrorMessage}</span>
                      </div>{" "}
                      <div className="bg-sky-600 border w-fit p-1 cursor-pointer">
                        <p>Terminate Job</p>
                      </div>
                    </div>}
                  </>
